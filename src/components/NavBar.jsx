  ...
  return (
    <nav className={`${isDark ? 'bg-gray-900 text-white border-gray-800' : 'bg-white text-gray-900 border-gray-100'} border-b shadow-sm sticky top-0 z-50 transition`}>
      <div className="max-w-7xl mx-auto px-6 py-3">
        ...
        {mobileMenuOpen && (
          <div className={`md:hidden mt-4 space-y-4 pb-4 border-t ${isDark ? 'border-gray-800' : 'border-gray-200'} pt-4`}>
            {/* Primary Nav Links */}
            ...
            <div className="space-y-1">
              ...
              <div className={`mx-3 p-3 rounded-xl border mt-3 flex flex-col gap-1 ${
                ...
                <p className="text-xs font-bold text-gray-700 dark:text-gray-300">{user?.name || 'Guest User'}</p>
              ...
              <button
                onClick={handleLogout}
                className="w-full text-left px-3 py-2.5 rounded-xl font-semibold text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-950/10 transition mt-2 flex items-center gap-2"
              >
